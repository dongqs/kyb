...
def convert_all
  ...
  body = <<~HOME
    ...
    <blockquote>
      <p>非常抱歉，青山所有的家人朋友们。</p>
      <p>没能守住你们的秘密。你们和我做过的所有事、说过的所有话，都已经打包上链了。</p>
      <p>快去换密码。以后和我说话前要想一想。</p>
    </blockquote>
    <p><strong>kyb 可以不。</strong> 一个 CLI 工具到纯知识的蜕变记录，以及这路上所有被卷进来的人。</p>
    <p>始于 2026-05-21 一场 FizzBuzz，终于 kybkyb.com。<!-- -->108 篇日记，全透明。</p>
    <h2>从哪开始读</h2>
    <ul>
